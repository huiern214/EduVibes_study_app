...
class ELibraryPage extends Component {
  ...
  render() {
    const firstRowEbooks = this.ebooks.slice(0, 3);
    const secondRowEbooks = this.ebooks.slice(3);
    ...
    return (
      <div>
        ...
        <Container style={{ width: '60rem' }}className="center-container">
          <Row>
            {firstRowEbooks.map((ebook) => (
        ...
        <Container style={{ width: '60rem' }} className="center-container2">
          <Row>
            {secondRowEbooks.map((ebook) => (
              <Col key={ebook.id} xs={12} md={4}>
                <Card style={{ width: '17rem' }}>
                  <Card.Img variant="top" src={ebook.imageUrl} className="ebook-image" />
                  <Card.Body>
